...
export function ComingSoon() {
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center gap-5 text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-sm border border-zinc-200 bg-zinc-50 text-accent dark:border-zinc-800 dark:bg-zinc-900">
