...
export function ProfilePhoto() {
  ...
  return (
    <div className="relative w-44 sm:w-48 md:w-52 lg:w-64 xl:w-72">
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-sm border border-zinc-200 bg-zinc-50">
        {src ? (
          <Image
            ...
            fill
            sizes="(min-width: 1280px) 288px, (min-width: 1024px) 256px, (min-width: 768px) 208px, (min-width: 640px) 192px, 176px"
